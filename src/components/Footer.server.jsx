    ...
    <footer className="footer classic-footer">
        ...
        <div className="container">
            ...
            <div className="col-lg-3 footer__first-column">
                {/* Footer logo */}
                <h5 className="footer__logo">DUROTAN</h5>
                {/* End footer logo */}
                {/* Footer address */}
            ...
            <div className="col-lg-3 footer__fourth-column blog-widget">
                ...
                {/* Description */}
                <div className="instagram__description">Following or tag us withs <a href="#">#durotan</a>, <a href="#">@durotan</a></div>
                {/* End description */}
                {/* Instagram feed */}
